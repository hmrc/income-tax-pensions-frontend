...
object ShortServiceRefundsRedirects {
  ...
  def indexCheckThenJourneyCheck(data: PensionsUserData, optIndex: Option[Int],
                                 currentPage: ShortServiceRefundsPages,
  ...
  private def previousQuestionIsAnswered(pageNumber: Int, optIndex: Option[Int], shortServiceRefundsViewModel: ShortServiceRefundsViewModel): Boolean = {
