...
pensions.reducedAnnualAllowanceAmount.error.noEntry = Enter the amount above the annual allowance
pensions.reducedAnnualAllowanceAmount.error.incorrectFormat = Enter the amount above the annual allowance in the correct format
pensions.reducedAnnualAllowanceAmount.error.overMaximum = The amount above the annual allowance must be less than £100,000,000,000
