...
object RadioButtonAmountForm {
  ...
  def radioButtonAndAmountForm(missingInputError: String,
                               ...
                               minAmountKey: String = "",
                               emptyFieldArguments: Seq[String] = Seq.empty[String]): Form[(Boolean, Option[BigDecimal])] =
    Form(
      tuple(
  ...
  private def amountFormatter(requiredKey: String,
                              wrongFormatKey: String,
                              maxAmountKey: String,
                              minAmountkey: String,
                              args: Seq[String]): Formatter[Option[BigDecimal]] =
