...
class BenefitsFromSchemeControllerISpec extends IntegrationTest with ViewHelpers with BeforeAndAfterEach with PensionsDatabaseHelper {
  ...
  private def url(taxYear: Int): String =
    s"/update-and-submit-income-tax-return/pensions/$taxYear/employment-financed-retirement-benefits-scheme/benefits-from-scheme"
