...
object OneOffRASPaymentsAmountSpec {
  ...
  object CommonExpectedEN extends CommonExpectedResults {
    ...
    val maxAmountErrorText =
      "The total amount of one-off payments paid into RAS pensions, plus basic rate tax relief, must be less than £100,000,000,000"
  ...
  object CommonExpectedCY extends CommonExpectedResults {
    ...
    val expectedHeading =
      "Cyfanswm y taliadau untro i mewn i bensiynau rhyddhad wrth y ffynhonnell (RAS), ynghyd â rhyddhad treth ar y gyfradd sylfaenol"
    val expectedTitle =
      "Cyfanswm y taliadau untro i mewn i bensiynau rhyddhad wrth y ffynhonnell (RAS), ynghyd â rhyddhad treth ar y gyfradd sylfaenol"
