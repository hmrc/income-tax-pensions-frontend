...
class AboveReducedAnnualAllowanceControllerISpec extends IntegrationTest with ViewHelpers with BeforeAndAfterEach with PensionsDatabaseHelper {
  ...
  object ExpectedIndividualCY extends SpecificExpectedResults {
    ...
    val expectedReducedHeading = "A ydych wedi mynd yn uwch na’ch lwfans blynyddol wedi’i ostwng?"
    ...
    val expectedNonReducedHeading = "A ydych wedi mynd yn uwch na’r lwfans blynyddol?"
  ...
  object ExpectedAgentCY extends SpecificExpectedResults {
    ...
    val expectedReducedHeading = "A yw’ch cleient wedi mynd yn uwch na’i lwfans blynyddol wedi’i ostwng?"
    val expectedReducedErrorTitle = s"Gwall: $expectedReducedTitle"
    ...
    val expectedNonReducedHeading = "A yw’ch cleient wedi mynd yn uwch na’r lwfans blynyddol?"
    val expectedNonReducedErrorTitle = s"Gwall: $expectedNonReducedTitle"
