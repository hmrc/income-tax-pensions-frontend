...
import controllers.pensions.lifetimeAllowances.routes.AnnualLifetimeAllowanceGatewayController
...
class AnnualLifetimeAllowanceGatewaySpec extends ViewUnitTest {
  ...
  object CommonExpectedEN extends CommonExpectedResults {
    override val expectedCaption: Int => String = (taxYear: Int) => s"Lifetime allowances for 6 April ${taxYear - 1} to 5 April $taxYear"
