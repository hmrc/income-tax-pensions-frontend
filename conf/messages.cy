...
incomeFromPensions.incomeFromPensionsSummary.otherUkPensions.text.individual = You only need to fill in the sections that apply to you.
incomeFromPensions.incomeFromPensionsSummary.otherUkPensions.text.agent = You only need to fill in the sections that apply to your client.
