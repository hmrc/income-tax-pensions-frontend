...
@Singleton
class StatePensionAddToCalculationController @Inject() (
  ...
  private def updateSessionData[T](pensionsUserData: PensionsUserData, addToCalculation: Boolean, taxYear: Int)(implicit
