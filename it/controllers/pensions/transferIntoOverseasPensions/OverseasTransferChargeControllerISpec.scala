...
class OverseasTransferChargeControllerISpec extends YesNoAmountControllerSpec("/overseas-pensions/overseas-transfer-charges/transfer-charge") {
    ...
    "appear as expected" when {
      ...
      "the user had previously answered 'Yes' with a valid amount, and" when {
        ...
        val sessionData = pensionsUserData(
          aPensionsCYAModel.copy(transfersIntoOverseasPensions = TransfersIntoOverseasPensionsViewModel(
  ...
  ".submit" should {
    "redirect to the start of the journey" when {
      ...
      "the page is invalid in the journey" in {
        val emptySchemesTIOPViewModel: TransfersIntoOverseasPensionsViewModel =
          emptyTransfersIntoOverseasPensionsViewModel.copy(transferPensionSavings = Some(false))
          ...
          scenarioNameForAgentAndEnglish in {
            ...
            assertOTCPageAsExpected(
              ...
              ExpectedYesNoAmountPageContents(
                ...
                amountSection = ExpectedAmountSection("Amount that resulted in a transfer charge, in pounds", "", Some("For example, £193.54")),
                errorSummarySectionOpt = Some(
                  ErrorSummarySection(title = "There is a problem", body = "Enter the amount that resulted in a transfer charge", link = "#amount-2")
                ),
                errorAboveElementCheckSectionOpt = Some(
                  ErrorAboveElementCheckSection(
          ...
          scenarioNameForIndividualAndEnglish in {
            ...
            assertOTCPageAsExpected(
              ...
              ExpectedYesNoAmountPageContents(
                ...
                buttonForContinue = ExpectedButton("Continue", ""),
                amountSection =
                  ExpectedAmountSection("Amount that resulted in a transfer charge, in pounds", "100,000,000,000", Some("For example, £193.54")),
                errorSummarySectionOpt = Some(
                  ErrorSummarySection(
                    title = "There is a problem",
          ...
          scenarioNameForIndividualAndEnglish in {
            ...
            assertOTCPageAsExpected(
              ...
              ExpectedYesNoAmountPageContents(
                ...
                errorSummarySectionOpt = Some(
                  ErrorSummarySection(title = "There is a problem", body = "Enter an amount greater than zero", link = "#amount-2")
                ),
                errorAboveElementCheckSectionOpt = Some(
                  ErrorAboveElementCheckSection(
          ...
          scenarioNameForIndividualAndWelsh ignore {
            ...
            assertOTCPageAsExpected(
              ...
              ExpectedYesNoAmountPageContents(
                ...
                amountSection = ExpectedAmountSection("Amount that resulted in a transfer charge, in pounds", "0", Some("For example, £193.54")),
                errorSummarySectionOpt = Some(
                  ErrorSummarySection(title = "Mae problem wedi codi", body = "Enter an amount greater than zero", link = "#amount-2")
                ),
                errorAboveElementCheckSectionOpt = Some(
                  ErrorAboveElementCheckSection(
                    title = "Error: Enter an amount greater than zero",
    ...
    "redirect to first page of journey" when {
      "previous question has not been answered" in {
        val incompleteCYAModel =
          aPensionsCYAModel.copy(transfersIntoOverseasPensions = TransfersIntoOverseasPensionsViewModel(transferPensionSavings = Some(false)))
  ...
  private def assertOTCPageAsExpected(expectedStatusCode: Int,
