...
class UnauthorisedPaymentControllerISpec extends IntegrationTest
  with ViewHelpers
  ...
  private def url(taxYear: Int): String = {
    s"/update-and-submit-income-tax-return/pensions/$taxYear/unauthorised-payments-from-pensions/unauthorised-payment"
  }
