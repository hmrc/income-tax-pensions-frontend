...
class PensionProviderPaidTaxViewSpec extends ViewUnitTest {
  ...
  object ExpectedIndividualCY extends SpecificExpectedResults {
    ...
    val errorAmountLessThan =
      "Mae’n rhaid i swm y dreth a dalwyd gan eich darparwr pensiwn, neu’r swm a gytunodd i’w dalu, fod yn llai na £100,000,000,000"
  }
  ...
  object ExpectedAgentCY extends SpecificExpectedResults {
    ...
    val errorAmountLessThan =
      "Mae’n rhaid i swm y dreth a dalwyd gan ddarparwr pensiwn eich cleient, neu’r swm a gytunodd i’w dalu, fod yn llai na £100,000,000,000"
  }
