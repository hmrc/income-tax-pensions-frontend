...
object TailoringEnabledFilterAction {
  def tailoringEnabledFilterAction(taxYear: Int)(implicit appConfig: AppConfig): TailoringEnabledFilterAction =
    new TailoringEnabledFilterAction(taxYear, appConfig)
}
