...
object PaymentsIntoPensionsCYASpec {
  ...
  object ChangeLinks {
    ...
    val reliefAtSourceAmount: String =
      controllers.pensions.paymentsIntoPensions.routes.ReliefAtSourcePaymentsAndTaxReliefAmountController.show(taxYearEOY).url
    ...
    val pensionsTaxReliefNotClaimed: String =
      controllers.pensions.paymentsIntoPensions.routes.PensionsTaxReliefNotClaimedController.show(taxYearEOY).url
