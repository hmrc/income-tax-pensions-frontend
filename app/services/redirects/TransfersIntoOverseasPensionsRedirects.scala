...
import controllers.pensions.transferIntoOverseasPensions.routes.{OverseasTransferChargePaidController,
  TransferChargeSummaryController, TransferIntoOverseasPensionsCYAController, TransferPensionSavingsController}
...
object TransfersIntoOverseasPensionsRedirects {
  ...
  def indexCheckThenJourneyCheck(data: PensionsUserData, optIndex: Option[Int],
                                 currentPage: TransfersIntoOverseasPensionsPages,
  ...
  private def previousQuestionIsAnswered(pageNumber: Int, optIndex: Option[Int], transferOverseasViewModel: TransfersIntoOverseasPensionsViewModel): Boolean = {
